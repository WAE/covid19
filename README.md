...
The following command will attempt to show the current statistics for [the default country](https://github.com/WAE/covid19/blob/master/.conf/COUNTRYNAME), Iceland and Norway: 	
```
